...
<script>
    ...
    function updateStudent(){
        var load = layer.load();
        $.ajax({
            url:'<%=request.getContextPath() %>/admin/update_student.do',
            type:'GET',
            async:false,    //是否异步
            data:{
                id:$("#id").val(),
    ...
    function insertStudent(){
        var load = layer.load();
        $.ajax({
            url:'<%=request.getContextPath() %>/admin/insert_student.do',
            type:'GET',
            async:false,    //是否异步
            data:{
                id:$("#id").val(),
        ...
        var $ = layui.$, active = {
          ...
          <div class="layui-form layui-form-pane">\
            ...
            <div class="layui-form-item">\
              ...
              <button class="layui-btn" onclick="insertStudent()">添加信息</button>\
          </div>\
        '
                });
            },
            refreshStudent: function(){
                table.reload('idTest', {
                    url: '<%=request.getContextPath() %>/admin/select_student_list.do'
                    ,where: {} //设定异步数据接口的额外参数
                });
            },
