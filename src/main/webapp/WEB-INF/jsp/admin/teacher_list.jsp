...
<script>
    ...
    function updateTeacher(){
        var load = layer.load();
        $.ajax({
            url:'<%=request.getContextPath() %>/admin/update_teacher.do',
            type:'GET',
            async:false,    //是否异步
            data:{
                id:$("#id").val(),
    ...
    function insertTeacher(){
        var load = layer.load();
        $.ajax({
            url:'<%=request.getContextPath() %>/admin/insert_teacher.do',
            type:'GET',
            async:false,    //是否异步
            data:{
                id:$("#id").val(),
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'detail'){
                ...
                if(false){
                    ...
                    layer.confirm('真的删除行么', {icon: 3}, function(index){
                        var load = layer.load();
                        $.ajax({
                            url:'<%=request.getContextPath() %>/admin/delete_teacher.do',
                            type:'GET',
                            async:false,    //是否异步
                            data:{
                                id:data.id
          ...
          <div class="layui-form layui-form-pane">\
            ...
            <div class="layui-form-item">\
              ...
              <button class="layui-btn" onclick="updateTeacher()">修改信息</button>\
          </div>\
        '
                });
                $("#id").val(data.id);
        ...
        var $ = layui.$, active = {
          ...
          <div class="layui-form layui-form-pane">\
            ...
            <div class="layui-form-item">\
              ...
              <button class="layui-btn" onclick="insertTeacher()">添加信息</button>\
          </div>\
        '
                });
            },
