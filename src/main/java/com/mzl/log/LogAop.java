...
public class LogAop {
    ...
    @Pointcut("execution(* com.mzl.controller..*.*(..))")
    ...
    public Object doBasicProfiling(ProceedingJoinPoint pjp) throws Throwable {
        ...
        //保存在实体中
        com.mzl.bean.Log log = new com.mzl.bean.Log(userId, ip, url, parameter, time, length, mod, met, result, message);
