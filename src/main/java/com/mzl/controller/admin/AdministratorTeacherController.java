...
/**
 * @ClassName :   AdministratorTeacherController
 * @Description: 管理员的老师
 * @Author: 21989
 * @CreateDate: 2020/6/3 16:29
 * @Version: 1.0
 */
@Controller
...
public class AdministratorTeacherController {
    ...
    public String updateTeacher(Teacher teacher, HttpServletResponse response) throws Exception {
